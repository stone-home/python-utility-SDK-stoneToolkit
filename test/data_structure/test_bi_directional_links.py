import pytest
from stone_lib.data_structure.bi_directional_links import BiDirection, NonCircularDoublyLinkedNode


class TestBiDirection:
    @pytest.fixture
    def setup_node(self):
        return BiDirection("node1")

    @pytest.fixture
    def setup_two_nodes(self):
        node1 = BiDirection("node1")
        node2 = BiDirection("node2")
    ...
    def test_str_and_repr(self, setup_node):
        ...
        assert repr(node) == "BiDirection(node1)"
